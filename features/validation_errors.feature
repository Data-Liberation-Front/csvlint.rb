...
"Foo","Bar","Baz"
  ...
  Scenario: Report invalid Encoding within CSV file
  ...
  Scenario: Correctly handle different encodings within CSV file
    Given I have a file called "invalid-byte-sequence.csv"
...
"abc","2","3"
  ...
  Scenario: Incorrect line endings on a CSV file specified in settings
  ...
  Scenario: inconsistent line endings on a CSV file cause an error
  ...
  Scenario: inconsistent line endings on a CSV file with unquoted fields in file cause an error
