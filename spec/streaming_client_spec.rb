...
describe Csvlint::StreamingClient do
  ...
  #     validator = Csvlint::StreamingClient.new("http://example.com/example.csv")
  ...
  #         "header" => true
  #     }
  #     validator = Csvlint::StreamingClient.new("http://example.com/example.csv", opts)
  #     expect( validator.header? ).to eql(true)
  #     opts = {
  #         "header" => false
  #     }
  ...
  #
  #     stub_request(:get, "http://example.com/example.csv").to_return(:status => 200, :headers=>{"Content-Type" => "text/csv"}, :body => File.read(File.join(File.dirname(__FILE__),'..','features','fixtures','valid.csv')))
  #     validator = Csvlint::StreamingClient.new("http://example.com/example.csv", {"header"=>true})
  #     expect( validator.valid? ).to eql(true)
  #
  #     stub_request(:get, "http://example.com/example.csv").to_return(:status => 200, :headers=>{"Content-Type" => "text/csv"}, :body => File.read(File.join(File.dirname(__FILE__),'..','features','fixtures','valid.csv')))
  #     validator = Csvlint::StreamingClient.new("http://example.com/example.csv", {"header"=>false})
  #     expect( validator.valid? ).to eql(true)
  #   end
  #
  # end
  ...
  #
  #     validator = Csvlint::StreamingClient.new("http://example.com/crlf.csv")
  #     validator.csv_state[:line_breaks].should == "\r\n"
  #
  #   end
  #
  # end
  ...
  #                                                                  :headers=>{"Content-Type" => "text/csv; header=present"},
  #                                                                  :body => File.read(File.join(File.dirname(__FILE__),'..','features','fixtures','valid.csv')))
  #   validator = Csvlint::StreamingClient.new("http://example.com/example.csv", nil, nil, limit_lines: 2)
  #   expect( validator.valid? ).to eql(true)
  #   data = validator.data
  ...
  #                                                                   :body => File.read(File.join(File.dirname(__FILE__),'..','features','fixtures','valid.csv')))
  #
  #   validator = Csvlint::StreamingClient.new("http://example.com/redirect")
  #   expect( validator.valid? ).to eql(true)
  # end
